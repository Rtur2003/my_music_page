export const translations = {
  tr: {
    ...
    software: {
      ...
      platformEyebrow: 'Diğer Çalışma Alanım',
      platformHeading: 'Mühendislik tarafının tamamı CrownCode’ta.',
      platformDesc: 'AURIS dahil tüm yapay zeka ve yazılım projelerimin teknik detaylarını, mimari kararlarını ve dokümantasyonunu ayrı bir platformda topluyorum.',
      platformCta: 'crowncode platformuna git',
    },
    contact: {
  ...
  en: {
    ...
    software: {
      ...
      platformEyebrow: 'Where the Engineering Lives',
      platformHeading: 'The full engineering side is on CrownCode.',
      platformDesc: 'I keep the technical detail, architecture decisions, and documentation for all my AI and software projects — AURIS included — on a separate platform.',
      platformCta: 'visit the crowncode platform',
    },
    contact: {
